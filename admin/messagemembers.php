...
$table = '<table cellpadding=2 align=center>';
...
$table .= <<<EOF
<tr>
<td width="50%" bgcolor="#f5f5f5" align=left><b><u>{$row2['title']}</u></b><BR>
{$row2['information']}<BR><BR>
</td>
...
<a href=https://union.ic.ac.uk/scc/finance/new/confirmattendance.php?event={$row2['ID']}&user={$user}&r=imperialcollegeunion>Signup</a>
</tr>
EOF;
     }
$table .= '</table>';
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td bgcolor="#EEEEEE">
<input type="hidden" name="submit" value="1"><input type="submit" name="button" id="button" value="Send email" /> This may take up to 30minutes. Please be patient. Just dont close your browser!
