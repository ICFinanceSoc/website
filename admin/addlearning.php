...
<body>
<h1>Add learning article
</h1>
<form action="addlearningscript.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
    ...
    <tr>
      <td bgcolor="#ddd">Document (pdf only)</td>
