    ...
    <div class="subbox">
        ...
        <div class="imagebox">
            ...
            <a title="ICFS Investment Club" href="http://www.iciclub.co.uk/" target="_blank">
                <img src="images/icic.jpg" alt="" width="400"/>
            </a>
        </div>
        <p class="displaytext">
    ...
    <div class="subbox last">
        ...
        <div class="imagebox">
            ...
            <a href="http://www.icfsconference.com/" target="_blank">
                <img src="images/nfw.jpg" alt="ICFS New Financial World Conference" width="400"/>
            </a>
        </div>
        <p class="displaytext">
    ...
    <div class="subbox last">
        ...
        <div class="imagebox">
            ...
            <a title="ICFS Entrepreneurs Interactive" href="http://entrepreneursinteractive.com/icbs/" target="_blank">
                <img src="images/ei.png" alt="Imperial College Finance Society - Entrepreneurs Interactive" width="400"/>
            </a>
        </div>
        <p class="displaytext">
