...
$from = "ICFS <noreply@financesociety.co.uk>";
if($subject == ''){
$subject = 'ICFS';
}
$message = <<<EOF
                              ...
                              <td valign="top" bgcolor="#334b6d" style="font-family: Helvetica, Verdana, sans-serif; background: #334b6d url(http://union.ic.ac.uk/scc/finance/email/bg_footer.png);">
                                <p>
                                    <a href="http://www.financesociety.co.uk/"></a><br />
                                        ...
                                        <p>In order to be recognized by our sponsors and the Union as an official member, it is essential that you 'purchase' our FREE membership <a href="http://www.imperialcollegeunion.org/finance-98/finance-membership/product.html"><strong>here</strong></a>!</p></td>
                                        <td bgcolor="#334b6d" style="font-family: Helvetica, Verdana, sans-serif; background: #334b6d url(http://union.ic.ac.uk/scc/finance/email/bg_footer.png);">&nbsp;</td>
                                          <td valign="top" bgcolor="#334b6d" style="font-family: Helvetica, Verdana, sans-serif; background: #334b6d url(http://union.ic.ac.uk/scc/finance/email/bg_footer.png);">
                                          <p>
                                              ...
                                              <forwardtoafriend style="font-size: 12px; font-weight: bold; text-decoration: underline; color: #fff;">
                                                <table width="130" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                          <td><a href="http://twitter.com/#!/ICFS100"><img src="http://union.ic.ac.uk/scc/finance/email/twitter.png" alt="Twitter" width="32" height="32" /></a></td>
                                                                <td><a href="http://www.facebook.com/groups/20171188344/"><img src="http://union.ic.ac.uk/scc/finance/email/facebook.png" alt="Facebook" width="32" height="32" /></a></td>
                                                                      <td><a href="http://www.linkedin.com/company/imperial-college-finance-society"><img src="http://union.ic.ac.uk/scc/finance/email/linkedin.png" alt="Linkedin" width="32" height="32" /></a></td>
                                                                          </tr>
                                                                            </table>
                                                                            </forwardtoafriend></td>
                                                                            <td bgcolor="#334b6d" style="font-family: Helvetica, Verdana, sans-serif; background: #334b6d url(http://union.ic.ac.uk/scc/finance/email/bg_footer.png);">&nbsp;</td>
                                                                              ...
                                                                              <p>
                                                                                <singleline label="Title"></singleline>
                                                                                                                    ...
                                                                                                                    <table width="130" border="0" cellspacing="0" cellpadding="0">
                                                                                                                          ...
                                                                                                                          <p><a href="http://twitter.com/#!/ICFS100"></a><a href="http://www.facebook.com/groups/20171188344/"></a><img src="http://union.ic.ac.uk/scc/finance/email/sign.png" alt=""  /><br />
                                                                                                                                                              </p>
                                                                                                                                                                                                  <p>Angad Rekhi           <br />President                         </p>
                                                                                                                                                                                                                                      <p><a href="mailto:president@financesociety.co.uk">president@financesociety.co.uk</a> 
                                                                                                                                                                                                                                                                        <br><a href="http://www.financesociety.co.uk/">Imperial College Finance Society</a></p></td>
                                                                                                                                                                                                                                                                          <td bgcolor="#334b6d" style="font-family: Helvetica, Verdana, sans-serif; background: #334b6d url(http://union.ic.ac.uk/scc/finance/email/bg_footer.png);">&nbsp;
                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                               <img src="http://union.ic.ac.uk/scc/finance/email/sponsors.png" alt="divider" style="display: block;" /><br /><img src="http://union.ic.ac.uk/scc/finance/email/bg_header_top.jpg" alt="divider" style="display: block;" />
                                                                                                                                                                                                                                                                                                                                               <p>&nbsp;</p></td>
