...
<table width="878" border="0" cellspacing="5" cellpadding="5">
  <?php do { ?>
    <tr>
      ...
      <td width="260" bgcolor="#eeeeee"><a href="viewregistered.php?ID=<?php echo $row_events['ID']; ?>" target="_blank">View all registered</a> <span class="notice">(opens new window)</span></td>
    </tr>
