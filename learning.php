...
?>
    ...
    <?php if(!isset($_SESSION['username'])) { ?>
				    ...
				    <?php if($totalRows_publication_sections > 0) { 
...
$totalRows_currentsection = mysql_num_rows($currentsection);
					  ?>
                            <?php if($totalRows_currentsection > 0) { ?><?php do { ?> <table width="100%" border="0" cellspacing="0" cellpadding="5">
                              ...
                              <tr>
                                ...
                                <td width="97%"><a href="viewarticle.php?ID=<?php echo $row_currentsection['ID']; ?>" target="_blank"><?php echo urldecode($row_currentsection['Title']); ?></a></td>
                                </tr>
                             </table> 
                  ...
                  <?php } } else { echo 'There are no files available'; } } ?> 
