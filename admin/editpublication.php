...
<form action="editpublicationscript.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td bgcolor="#eee"><input type="submit" name="button" id="button" value="Edit publication" />
