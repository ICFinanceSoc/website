    ...
    <div class="displaytext">
        ...
        <div style="">
            <div class="next-lecture">
                ...
                <?php if(isset($_SESSION['username'])) { echo '<a href="/content/TEC3.pdf">download</a>'; } else {echo '<a href="https://www.financesociety.co.uk/requirelogin.php">Login to download lecture summary</a>'; } ?>
            </div>
            <div class="next-lecture">
            ...
            <div class="next-lecture">
                ...
                <?php if(isset($_SESSION['username'])) { echo '<a href="/content/TEC1.pdf">download</a>'; } else {echo '<a href="https://www.financesociety.co.uk/requirelogin.php">Login to download lecture summary</a>'; } ?>
            </div>
