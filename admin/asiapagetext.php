...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE asia SET title=%s, body=%s WHERE ID=%s",
  ...
  $updateGoTo = "asiapagetext.php?message=Region updated";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_sql, $sql);
$query_Recordset1 = "SELECT * FROM asia WHERE ID = 1";
